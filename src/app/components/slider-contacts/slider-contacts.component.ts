...
@Component({
  selector: 'app-slider-contacts',
  templateUrl: './slider-contacts.component.html',
  styleUrls: ['./slider-contacts.component.scss']
})
export class SliderContactsComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      let panel = document.getElementById("slidecontent");
